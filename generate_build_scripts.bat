...
REM ── VidaPay repos ──
call :WRITE VidaPay_Incentive_Extractor VidaPay_Incentive_Extractor_FULL VidaPay_Incentive_Extractor_FULL
call :WRITE VidaPay_Incentive_Extractor VidaPay_Incentive_Extractor_TRIAL VidaPay_Incentive_Extractor_TRIAL
call :WRITE VidaPay_Incentive_Extractor VidaPay_Incentive_Extractor_TRIAL_1Y VidaPay_Incentive_Extractor_TRIAL_1Y
...
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_FULL VidaPay_Device_Ordering_FULL
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_FULL_MULTIBROWSER VidaPay_Device_Ordering_FULL_MULTIBROWSER
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_FULL_NOCLONE VidaPay_Device_Ordering_FULL_NOCLONE
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_FULL_NOCLONE_MULTIBROWSER VidaPay_Device_Ordering_FULL_NOCLONE_MULTIBROWSER
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL VidaPay_Device_Ordering_TRIAL
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL_1YEAR VidaPay_Device_Ordering_TRIAL_1YEAR
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL_1Y_MULTIBROWSER VidaPay_Device_Ordering_TRIAL_1Y_MULTIBROWSER
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL_1Y_NOCLONE VidaPay_Device_Ordering_TRIAL_1Y_NOCLONE
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL_MULTIBROWSER VidaPay_Device_Ordering_TRIAL_MULTIBROWSER
call :WRITE VidaPay_Device_Ordering VidaPay_Device_Ordering_TRIAL_NOCLONE VidaPay_Device_Ordering_TRIAL_NOCLONE
